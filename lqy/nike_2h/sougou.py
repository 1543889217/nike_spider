...
def main(word):
    ...
    while True:
        ...
        for i in hrefs:
            ...
            # TODO
            hdfs.new_write('/user/cspider_daily/nike_2h/qa/%s/%s/160_%s_%s_sougou.json' % (
...
def ask1(html, urls, view_count, title, i,topic_date,topic_time):
    ...
    for j in range(5):
        ...
        care = {"platform": "搜狗问问回答", "date": riqi, "time": shijian, "author": ''.join(autors1),
                ...
                "topic_id": topic_id, "author_id": ''.join(autors_id), "dislikes": ''.join(dislikes),"reposts_count":'' ,"audiourl": '', "imageurl": ""}
